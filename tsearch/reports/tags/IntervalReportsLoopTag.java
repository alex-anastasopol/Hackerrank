...
public class IntervalReportsLoopTag extends GenericReportsLoopTag{
	...
	//all report's entryes are necesary.
	...
	protected Object[] createObjectList() throws Exception {
		...
		logger.debug("Time Spent on IntervalReportsLoopTag.createObjectList from begining to before sql took " + (startSQLTime - startTime));
		...
		logger.debug("Time Spent on IntervalReportsLoopTag.createObjectList for sql took " + (System.currentTimeMillis() - startSQLTime));
		...
		logger.debug("Time Spent on IntervalReportsLoopTag.createObjectList for ALL took " + (System.currentTimeMillis() - startTime));
		return ReportData;
	}
