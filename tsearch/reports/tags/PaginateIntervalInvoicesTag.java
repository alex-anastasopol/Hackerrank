...
public class PaginateIntervalInvoicesTag extends GenericPaginateReportsTag {
	...
	private static final Logger logger = Logger.getLogger(PaginateIntervalInvoicesTag.class);
