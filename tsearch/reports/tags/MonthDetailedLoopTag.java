...
public class MonthDetailedLoopTag extends GenericReportsLoopTag{
	...
	private static final Logger logger = Logger.getLogger(MonthDetailedLoopTag.class);
	...
	protected Object[] createObjectList() throws Exception {
		...
		/*ReportData = DBReports.getMonthDetailedData(
				reportCounty, reportAbstractor, reportAgent, reportState, reportCompanyAgent, 
				monthReport, yearReport, 
				orderBy, orderType, commId, reportStatus, invoice,offset,rowsPerPage,ua);
		*/
