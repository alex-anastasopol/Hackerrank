...
/*
 * Class used for extraction of data from XML files that contain data for AutomaticSearchTest procedure 
 * 
*/
public class XMLAutomaticTestDataReader {
	       
	    
	   
	     static Document documentRead; 
	     //Contains the Dom of the parsed XML   
	     
	     static Document idTestCase;
	     //contains the id of the test case 
		...
		//============================= processing methods ======================================
	      ...
	      * */
	       ...
	       try{
	           ...
	           documentRead = builder.parse( new File("hello1234") );     //read the DOM from the file with data from Automatic Test
	     ...
	     public void testIDReaderFromDOM(Document d){
	    	 //Reads the XML file and parse the XML in a DOM  , then extract the ID field from the DOM object so that the data can be used to be saved in the data base 
		        DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
		        factory.setValidating(true);   
		        factory.setNamespaceAware(true);
	     ...
	     public void testDataReaderFromDOM(Document d){
