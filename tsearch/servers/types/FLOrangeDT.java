 ...
 */
public class FLOrangeDT extends FLSubdividedBasedDASLDT{
	
	private static final long serialVersionUID = -1256127088901832521L;

	public FLOrangeDT(long searchId) {
		super(searchId);
	}
	
	public FLOrangeDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
