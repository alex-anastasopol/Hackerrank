 ...
 */
public class FLMarionDT extends FLSubdividedBasedDASLDT{

	private static final long serialVersionUID = 3477834L;

	public FLMarionDT(long searchId) {
		super(searchId);
	}
	
	public FLMarionDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
