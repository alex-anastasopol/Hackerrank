 ...
 **/
public class CALosAngelesDT extends CAGenericDASLDT {
	...
	public CALosAngelesDT(long searchId) {
		super(searchId);
	}

	public CALosAngelesDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
