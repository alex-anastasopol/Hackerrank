 ...
 **/
public class CAVenturaDT extends CAGenericDASLDT{

	private static final long serialVersionUID = -7213953427179257999L;

	public CAVenturaDT(long searchId) {
		super(searchId);
	}

	public CAVenturaDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
	...
	public TSServerInfo getDefaultServerInfo() {
		...
		if ( !StringUtils.isEmpty(pin) ) {
			...
			if ( pinSize >= 10) {
				String pin1 = pin.substring(0, 3); // split in 3-1-3-3 format
				String pin2 = pin.substring(3, 4);
				String pin3 = pin.substring(4, 7);
				String pin4 = pin.substring(7, 10);
