 ...
 */
public class FLFlaglerDT extends FLSubdividedBasedDASLDT{

	private static final long serialVersionUID = 3477834L;

	public FLFlaglerDT(long searchId) {
		super(searchId);
	}
	
	public FLFlaglerDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
