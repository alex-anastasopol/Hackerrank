 ...
 */
public class FLIndianRiverDT extends FLSubdividedBasedDASLDT{
	
	private static final long serialVersionUID = -1256127088901832521L;

	public FLIndianRiverDT(long searchId) {
		super(searchId);
	}
	
	public FLIndianRiverDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
