 ...
 **/
public class CAContraCostaDT extends CAGenericDASLDT {
	...
	public TSServerInfo getDefaultServerInfo() {
		...
		if ( !StringUtils.isEmpty(pin) ) {
			...
			if ( pinSize >= 9 && !pin.contains("-") ) {
				...
				if( pinSize >= 10 ){
					newpin += ("-" + pin.substring( 9, pinSize ));
				}
				pin = newpin;
			}
		}
	...
	public CAContraCostaDT(long searchId) {
		super(searchId);
	}

	public CAContraCostaDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
