 ...
 */
public class FLHillsboroughDT extends FLSubdividedBasedDASLDT{

	private static final long serialVersionUID = 3477834L;

	public FLHillsboroughDT(long searchId) {
		super(searchId);
	}
	
	public FLHillsboroughDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
	...
	public void addAssesorMapSearch(TSServerInfoModule module, PersonalDataStruct str) {
		...
		String apn = search.getSa().getAtribute( SearchAttributes.LD_PARCELNO3 ).replaceAll("[.-]", "");
