 ...
 **/
public class CAKingsDT extends CAGenericDASLDT {
	...
	public TSServerInfo getDefaultServerInfo() {
		...
		if ( !StringUtils.isEmpty(pin) ) {
			...
			if ( pinSize >= 0 && !pin.contains("-") ) {
				
				String pin1 = pin.substring(0, 3); // split in 4 - 3 - 3 format 018-700-023
	...
	public CAKingsDT(long searchId) {
		super(searchId);
	}

	public CAKingsDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
