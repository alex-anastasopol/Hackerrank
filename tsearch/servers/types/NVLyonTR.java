 ...
 *
 */
public class NVLyonTR extends NVGenericCountyTR {

	private static final long serialVersionUID = 1L;

	public NVLyonTR(String rsRequestSolverName, String rsSitePath,
	...
	protected TableTag extractIntermediaryTable(NodeList nodeList) {
		...
		TableTag interTable = (TableTag) nodeList
			.extractAllNodesThatMatch(new HasAttributeFilter("name", "Results"), true)
