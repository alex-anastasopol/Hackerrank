 ...
 */
public class FLDuvalDT extends FLSubdividedBasedDASLDT{
	
	private static final long serialVersionUID = -1256127088901832521L;

	public FLDuvalDT(long searchId) {
		super(searchId);
	}
	
	public FLDuvalDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
