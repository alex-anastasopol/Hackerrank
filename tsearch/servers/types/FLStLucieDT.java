 ...
 */
public class FLStLucieDT extends FLSubdividedBasedDASLDT {

	private static final long serialVersionUID = 31723434L;

	public FLStLucieDT(long searchId) {
		super(searchId);
	}
	
	public FLStLucieDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
