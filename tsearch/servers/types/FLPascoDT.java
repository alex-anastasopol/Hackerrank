 ...
 */
public class FLPascoDT extends FLSubdividedBasedDASLDT{

	private static final long serialVersionUID = 34377834L;

	public FLPascoDT(long searchId) {
		super(searchId);
	}
	
	public FLPascoDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
