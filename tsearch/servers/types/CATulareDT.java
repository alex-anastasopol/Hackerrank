 ...
 **/
public class CATulareDT extends CAGenericDASLDT {
	...
	public TSServerInfo getDefaultServerInfo() {
		...
		if ( !StringUtils.isEmpty(pin) ) {
			...
			if ( pinSize >= 10 && !pin.contains("-") ) {
				...
				String pin1 = pin.substring(0, 4); // split in 4 - 3 - 3 format
				String pin2 = pin.substring(4, 7);
				String pin3 = pin.substring(7, 10);
	...
	public CATulareDT(long searchId) {
		super(searchId);
	}

	public CATulareDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
