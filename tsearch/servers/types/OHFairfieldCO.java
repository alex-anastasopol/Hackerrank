...
public class OHFairfieldCO extends OHGenericCourtViewCO {
	
	private static final long serialVersionUID = -6155635870050393103L;
	
	private static String FAIRFIELD_SUFFIX_SELECT = "";
	...
	static {
		...
		try {
			FAIRFIELD_SUFFIX_SELECT = org.apache.commons.io.FileUtils.readFileToString(new File(folderPath + File.separator + "OHFairfieldCOSuffix.xml"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public OHFairfieldCO(long searchId) {
		super(searchId);
		resultType = MULTIPLE_RESULT_TYPE;
	}
	
	public OHFairfieldCO(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int miServerID) {
	...
	public TSServerInfo getDefaultServerInfo() {
		...
		if (tsServerInfoModule != null) {
			setupSelectBox(tsServerInfoModule.getFunction(3), FAIRFIELD_SUFFIX_SELECT);
		}
