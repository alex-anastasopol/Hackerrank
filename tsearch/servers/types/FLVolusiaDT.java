 ...
 */
public class FLVolusiaDT extends FLSubdividedBasedDASLDT{

	private static final long serialVersionUID = 3466577834L;

	public FLVolusiaDT(long searchId) {
		super(searchId);
	}
	
	public FLVolusiaDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
