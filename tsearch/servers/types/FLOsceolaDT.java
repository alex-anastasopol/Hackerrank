 ...
 */
public class FLOsceolaDT extends FLSubdividedBasedDASLDT{
	
	private static final long serialVersionUID = -1256127088901832521L;

	public FLOsceolaDT(long searchId) {
		super(searchId);
	}
	
	public FLOsceolaDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
