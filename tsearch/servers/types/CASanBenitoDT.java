 ...
 **/
public class CASanBenitoDT extends CAGenericDASLDT {
	...
	public TSServerInfo getDefaultServerInfo() {
		...
		if ( !StringUtils.isEmpty(pin) ) {
			...
			if ( pinSize >= 10 && !pin.contains("-") ) {
				...
				String pin1 = pin.substring(0, 3); // split in 4 - 3 - 3 forma017-080-049-0
				String pin2 = pin.substring(3, 6);
				String pin3 = pin.substring(6, 9);
				String pin4 = pin.substring(9);
	...
	public CASanBenitoDT(long searchId) {
		super(searchId);
	}

	public CASanBenitoDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
