...
public class FLStJohnsTR extends FLGenericGovernmaxTR {
	...
	private static final CheckTangible CHECK_TANGIBLE = new CheckTangible() {
		public boolean isTangible(String row){
			...
			return searchdat5.matches("\\d+-\\d+");
		}
	};
	
	public FLStJohnsTR(String rsRequestSolverName, String rsSitePath, String rsServerID,
	...
	protected void setModulesForAutoSearch(TSServerInfo serverInfo) {
		...
		if(hasAddress()){
			...
			module.getFunction(1).setIteratorType(FunctionStatesIterator.ITERATOR_TYPE_ST_NAME_FAKE);
			module.addFilter(rnre);
	...
	public ServerResponse SearchBy(TSServerInfoModule module, Object sd) throws ServerResponseException {
        ...
        if(module.getModuleIdx() == TSServerInfo.PARCEL_ID_MODULE_IDX){
        	// turn 1829430150 into 182943-0150     	
        	String pin = module.getFunction(0).getParamValue();
        	pin = pin.replaceFirst("\\s*(\\d{6})-?(\\d{4})s*", "$1-$2");
