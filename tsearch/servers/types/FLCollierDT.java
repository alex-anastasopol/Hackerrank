...
public class FLCollierDT extends FLSubdividedBasedDASLDT{

	private static final long serialVersionUID = 3477834L;

	public FLCollierDT(long searchId) {
		super(searchId);
	}
	
	public FLCollierDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
