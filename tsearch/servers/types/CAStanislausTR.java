...
public class CAStanislausTR extends CAMegabyteCommonSiteTR {
	...
	public CAStanislausTR(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int miServerID) {
	...
	protected void setModulesForAutoSearch(TSServerInfo serverInfo) {
		...
		if (searchType == Search.AUTOMATIC_SEARCH) {
			if (hasPin()) {
				...
				module.forceValue(1, "=");// search type - 'equal to'
