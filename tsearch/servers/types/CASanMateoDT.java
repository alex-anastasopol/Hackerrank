...
import com.stewart.ats.base.name.NameI;
	 ...
	 **/
	public class CASanMateoDT extends CAContraCostaDT {
		
		private static final long serialVersionUID = -3061664487262517109L;

		public CASanMateoDT(long searchId) {
			super(searchId);
		}

		public CASanMateoDT(String rsRequestSolverName, String rsSitePath, String rsServerID, String rsPrmNameLink, long searchId, int mid) {
